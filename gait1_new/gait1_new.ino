...
void setup() {
  ...
  // Set operating mode
  dxl.setOperatingMode(LR_WHEG, OP_POSITION);
  dxl.setOperatingMode(LM_WHEG, OP_POSITION);
  dxl.setOperatingMode(LF_WHEG, OP_POSITION);
  dxl.setOperatingMode(RR_WHEG, OP_POSITION);
  dxl.setOperatingMode(RM_WHEG, OP_POSITION);
  dxl.setOperatingMode(RF_WHEG, OP_POSITION);
  dxl.setOperatingMode(FRONT_PIVOT, OP_POSITION);
  dxl.setOperatingMode(REAR_PIVOT, OP_POSITION);

  // set velocity and postion limits for hinge
...
// set velocity limits for whegs
  dxl.writeControlTableItem(PROFILE_VELOCITY, LR_WHEG, 50);
  dxl.writeControlTableItem(PROFILE_VELOCITY, LM_WHEG, 50);
  dxl.writeControlTableItem(PROFILE_VELOCITY, LF_WHEG, 50);
  dxl.writeControlTableItem(PROFILE_VELOCITY, RR_WHEG, 50);
  dxl.writeControlTableItem(PROFILE_VELOCITY, RM_WHEG, 50);
  dxl.writeControlTableItem(PROFILE_VELOCITY, RF_WHEG, 50);
...
dxl.setGoalPosition(LM_WHEG, 0, UNIT_DEGREE);
dxl.setGoalPosition(LF_WHEG, 0, UNIT_DEGREE);
dxl.setGoalPosition(RR_WHEG, 0, UNIT_DEGREE);
dxl.setGoalPosition(RM_WHEG, 0, UNIT_DEGREE);
dxl.setGoalPosition(RF_WHEG, 0, UNIT_DEGREE);
...
void loop() {
  ...
  int RPM_forwards_left = 20;
  int RPM_forwards_right = -20;
  int stop = 0;
